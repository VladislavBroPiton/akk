...
const CATALOG = {
  acc: {
    ...
    products: [
      ...
      { name:'VARTA Silver Dynamic AGM 74Ah', brand:'VARTA',  tech:'agm', capacity:74,  cranking:750, polarity:'reverse', case:'euro', use:['auto'],            price:5000, isNew:false, dims:'278×175×190', warranty:'6 месяцев', caseSize:'L3' },
      ...
      { name:'VARTA Black Dynamic 60Ah',      brand:'VARTA',  tech:'ca',  capacity:60,  cranking:540, polarity:'reverse', case:'euro', use:['auto'],            price:5000, isNew:false, dims:'242×175×190', warranty:'6 месяцев', caseSize:'L2' },
      ...
      { name:'VARTA Silver Dynamic AGM 80Ah', brand:'VARTA',  tech:'agm', capacity:80,  cranking:800, polarity:'reverse', case:'euro', use:['auto'],            price:5000, isNew:false, dims:'315×175×175', warranty:'6 месяцев', caseSize:'L4' },
      ...
      { name:'TOPLA Energy 70Ah',             brand:'TOPLA',  tech:'ca',  capacity:70,  cranking:700, polarity:'reverse', case:'euro', use:['auto'],            price:5000, isNew:false, dims:'278×175×190', warranty:'6 месяцев', caseSize:'L3' },
      ...
      { name:'TOPLA Premium 80Ah',            brand:'TOPLA',  tech:'ca',  capacity:80,  cranking:800, polarity:'reverse', case:'euro', use:['auto'],            price:5000, isNew:true,  dims:'315×175×175', warranty:'6 месяцев', caseSize:'L4' },
      ...
      { name:'ZUBR Asia 65Ah',                brand:'ZUBR',   tech:'ca',  capacity:65,  cranking:580, polarity:'direct',  case:'asia', use:['auto'],            price:5000, isNew:true,  dims:'242×175×190', warranty:'6 месяцев', caseSize:'L3' },
      ...
      { name:'PLATIN PRO 75Ah',               brand:'PLATIN', tech:'ca',  capacity:75,  cranking:720, polarity:'reverse', case:'euro', use:['auto'],            price:5000, isNew:false, dims:'278×175×190', warranty:'6 месяцев', caseSize:'L3' },
      { name:'ENEUS Energy 60Ah',             brand:'ENEUS',  tech:'ca',  capacity:60,  cranking:520, polarity:'reverse', case:'euro', use:['auto'],            price:5000, isNew:false, dims:'242×175×190', warranty:'6 месяцев', caseSize:'L2' },
    ],
  },
