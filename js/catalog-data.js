...
const CATALOG = {
  acc: {
    ...
    products: [
      { name:'VARTA Silver Dynamic AGM 70Ah', brand:'VARTA',  tech:'agm', capacity:70,  cranking:760, polarity:'reverse', case:'euro', use:['auto'],            price:null, isNew:false, dims:'278×175×190', warranty:'6 месяцев', caseSize:'L3' },
      ...
      { name:'VARTA Blue Dynamic EFB N70',    brand:'VARTA',  tech:'efb', capacity:70,  cranking:630, polarity:'direct',  case:'asia', use:['auto'],            price:null, isNew:true,  dims:'278×175×190', warranty:'6 месяцев', caseSize:'L3' },
      ...
      { name:'VARTA Silver Dynamic 72Ah',     brand:'VARTA',  tech:'ca',  capacity:72,  cranking:680, polarity:'reverse', case:'euro', use:['auto'],            price:null, isNew:false, dims:'278×175×190', warranty:'6 месяцев', caseSize:'L3' },
      ...
      { name:'VARTA Powersports AGM 12Ah',    brand:'VARTA',  tech:'agm', capacity:12,  cranking:200, polarity:'direct',  case:'asia', use:['moto'],            price:null, isNew:false, dims:'150×65×130',  warranty:'6 месяцев', caseSize:'special' },
      ...
      { name:'TOPLA Top 55Ah',                brand:'TOPLA',  tech:'ca',  capacity:55,  cranking:540, polarity:'reverse', case:'euro', use:['auto'],            price:null, isNew:false, dims:'242×175×190', warranty:'6 месяцев', caseSize:'L2' },
      ...
      { name:'TOPLA Marine 90Ah',             brand:'TOPLA',  tech:'gel', capacity:90,  cranking:700, polarity:'reverse', case:'euro', use:['boat','traction'], price:null, isNew:false, dims:'353×175×190', warranty:'6 месяцев', caseSize:'L5' },
      ...
      { name:'ZUBR Тяговый 100Ah',            brand:'ZUBR',   tech:'gel', capacity:100, cranking:750, polarity:'reverse', case:'euro', use:['traction'],        price:null, isNew:false, dims:'353×175×190', warranty:'6 месяцев', caseSize:'L6' },
      ...
      { name:'ENEUS Energy 60Ah',             brand:'ENEUS',  tech:'ca',  capacity:60,  cranking:520, polarity:'reverse', case:'euro', use:['auto'],            price:null, isNew:false, dims:'242×175×190', warranty:'6 месяцев', caseSize:'L2' },
    ],
  },
  ...
  charge: {
    ...
    filters: ['chargeType', 'voltage', 'dualVoltage', 'current'],
    products: [
      { name:'Зарядное устройство трансформаторное 12 В, 4 A',   chargeType:'transformer', voltage:'12', dualVoltage:'no',  current:4,  price:null, isNew:false },
      { name:'Трансформаторное ЗУ 12 В, 8 A',                    chargeType:'transformer', voltage:'12', dualVoltage:'no',  current:8,  price:null, isNew:false },
      { name:'Зарядное устройство 12/24 В, 10 A',                chargeType:'transformer', voltage:'12', dualVoltage:'yes', current:10, price:null, isNew:true  },
      { name:'ЗУ для мото-аккумуляторов 6 В, 2 A',               chargeType:'transformer', voltage:'6',  dualVoltage:'no',  current:2,  price:null, isNew:false },
      { name:'Импульсное ЗУ 12 В, 6 A',                          chargeType:'pulse',       voltage:'12', dualVoltage:'no',  current:6,  price:null, isNew:false },
      { name:'Зарядно-восстановительное ЗУ 12 В, 10 A',          chargeType:'pulse',       voltage:'12', dualVoltage:'no',  current:10, price:null, isNew:true  },
      { name:'Пуско-зарядное устройство 12 В, 20 A',             chargeType:'jump',        voltage:'12', dualVoltage:'no',  current:20, price:null, isNew:false },
      { name:'Пуско-зарядное устройство 12/24 В, 25 A',          chargeType:'jump',        voltage:'12', dualVoltage:'yes', current:25, price:null, isNew:false },
    ],
  },
  ...
  access: {
    ...
    products: [
      ...
      { name:'Перемычка АКБ силовая',               accType:'wire',     material:'copper',  price:null, isNew:false },
      { name:'Провод соединительный аккумуляторный',accType:'wire',     material:'copper',  price:null, isNew:false },
      ...
      { name:'Провода прикуривателя 400 A',         accType:'jumper',   material:'copper',  price:null, isNew:true  },
      { name:'Провода прикуривателя 600 A',         accType:'jumper',   material:'copper',  price:null, isNew:false },
      { name:'Ареометр для электролита',            accType:'other',    material:'plastic', price:null, isNew:false },
      { name:'Щётка для чистки клемм',              accType:'other',    material:'steel',   price:null, isNew:false },
      { name:'Тестер аккумулятора цифровой',        accType:'other',    material:'plastic', price:null, isNew:true  },
    ],
  },
};
